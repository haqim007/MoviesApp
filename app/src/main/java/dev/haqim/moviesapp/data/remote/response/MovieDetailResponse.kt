...
import dev.haqim.moviesapp.data.util.toUSD
...
fun MovieDetailResponse.toModel(): Movie{
	return Movie(
		id = this.id,
		genres = this.genres.map { Genre(it.name, id = it.id) },
		title = this.originalTitle,
		plotSummary = this.overview,
		posterUrl = BuildConfig.BASE_IMAGE_URL + this.posterPath,
		status,
		budget.toUSD(),
		revenue.toUSD(),
